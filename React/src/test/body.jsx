...
import { Anchor, Footer, Card, CardHeader,round,CardBody, CardFooter, Grommet, Main, Text, Box, Avatar, Button, background, Header, Menu, Heading, Image, texture,InfiniteScroll,DataChart, Grid} from 'grommet';
...
class MainBody extends PureComponent {
    ...
    render() {
        ...
        return (
            <Box>
                    <Box className='welcom'
                        justify="center"
                        align="center"
                        pad="xlarge"
                        background="linear-gradient(102.77deg, #865ED6 -9.18%, #18BAB9 209.09%)"
                        round="large"
                        margin={{left:'xlarge',right:'xlarge',top:'small',bottom:'medium'}}
                    >
                    <h1>가장 신뢰받는 글로벌 표준 디지털 자산 거래소</h1>
                    <span>안전하고 투명한 시스템으로 빠르고 편리한 거래 환경을 제공합니다</span>
                    <div>
                        <span>
                            지도 api
                        </span>
